...
public class GiftProgressMeFragment extends BaseFragment {

    public GiftProgressMeFragment instance;
    ...
    public GiftProgressMeFragment getInstance(String type) {
//        if (instance == null) {
        Bundle bundle = new Bundle();
        bundle.putString("type", type);
        instance = new GiftProgressMeFragment();

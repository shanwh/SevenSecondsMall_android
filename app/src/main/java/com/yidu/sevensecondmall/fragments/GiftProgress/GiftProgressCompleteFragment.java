...
import com.yidu.sevensecondmall.views.adapter.GiftProgressAdapter.GiftProgressCompleteAdapter;
...
public class GiftProgressCompleteFragment extends BaseFragment {

    public GiftProgressCompleteFragment instance;
    ...
    Unbinder unbinder;
    String type;
    private GiftProgressCompleteAdapter adapter;
    private RecommendAdapter myAdapter;

    public GiftProgressCompleteFragment getInstance(String type) {
//        if (instance == null) {
        Bundle bundle = new Bundle();
        bundle.putString("type", type);
        instance = new GiftProgressCompleteFragment();
...
//        }
    ...
    protected void findViews(View view) {
        ...
        adapter = new GiftProgressCompleteAdapter(getActivity());

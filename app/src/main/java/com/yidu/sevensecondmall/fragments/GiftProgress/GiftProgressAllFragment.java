...
public class GiftProgressAllFragment extends BaseFragment {

    public GiftProgressAllFragment instance;
    ...
    private GiftProgressAllAdapter adapter;
    private RecommendAdapter myAdapter;

    public GiftProgressAllFragment getInstance(String type) {
//        if (instance == null) {
        Bundle bundle = new Bundle();
        bundle.putString("type", type);
        instance = new GiftProgressAllFragment();
...
//        }
    ...
    protected void findViews(View view) {
        ...
        adapter = new GiftProgressAllAdapter(getActivity());

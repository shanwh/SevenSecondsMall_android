...
public class AssetsDatabaseManager {
    ...
    private static String databasepath = "/data/data/com.yidu.sevensecondmall/database"; // %s is packageName
//    private static String databasepath = "/data/data/com.yidu.dingtest/database"; // %s is packageName

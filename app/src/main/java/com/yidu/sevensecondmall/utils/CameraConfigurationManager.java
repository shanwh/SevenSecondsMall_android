...
//            ScreenUtils.getScreenHeight(context), parameters.getSupportedPictureSizes());
...
//    screenResolution = new Point(mPictureResolution.width,mCameraResolution.height);
...
//    parameters.setPreviewSize(cameraResolution.x, cameraResolution.y);
    ...
    mCameraResolution = findCloselySize(ScreenUtils.getScreenWidth(context), ScreenUtils.getScreenHeight(context),supportedPreviewSizes);
//    mPictureResolution = findCloselySize(ScreenUtils.getScreenWidth(context), ScreenUtils.getScreenHeight(context),parameters.getSupportedPictureSizes());
//    int width = supportedPreviewSizes.get(position).width;
//    int height = supportedPreviewSizes.get(position).height;
    int width = mCameraResolution.width;
    int height = mCameraResolution.height;
    Log.d(TAG, "Setting preview size: " + cameraResolution);
    ...
    parameters.setPictureSize(mCameraResolution.width,mCameraResolution.height);
    setFlash(parameters);
    setZoom(parameters);

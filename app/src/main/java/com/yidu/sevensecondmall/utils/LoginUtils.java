...
public class LoginUtils {
    ...
    public static String getDing_coin() {
        return SystemUtil.getSharedString("ding_coin");
    }

    public static void setDing_coin(String ding_coin) {
        SystemUtil.setSharedString("ding_coin", ding_coin);
    }

    public static String getUser_money() {
        return SystemUtil.getSharedString("user_money");
    }

    public static void setUser_money(String user_money) {
        SystemUtil.setSharedString("user_money", user_money);
    }

    public static String getDaxiong_coin() {
        return SystemUtil.getSharedString("daxiong_coin");
    }

    public static void setDaxiong_coin(String daxiong_coin) {
        SystemUtil.setSharedString("daxiong_coin", daxiong_coin);
    }

    public static String ding_coin;
    public static String user_money;
    public static String daxiong_coin;
    ...
    public static void setSwitch(boolean open) {
        SystemUtil.setSharedBoolean("open", open);
    }

    public static boolean getSwitch() {
        return SystemUtil.getSharedBoolean("open", true);
    }
    ...
    public static String getUsername() {
        return SystemUtil.getSharedString("username");
    }

    public static void setUsername(String username) {
        SystemUtil.setSharedString("username", username);
    }
    ...
    public static void setLoginOpenid(String u) {
        SystemUtil.setSharedString("openid", u);
    }

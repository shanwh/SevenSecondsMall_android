...
public class AddressAlertDialog {
	...
	public AddressAlertDialog builder() {
		// 获取Dialog布局
	...
	public AddressAlertDialog setTitle(String title) {
		showTitle = true;
		if ("".equals(title)) {
			txt_title.setText("");
		} else {
	...
	public AddressAlertDialog setEditText(String msg) {
		showEditText = true;
		if ("".equals(msg)) {
	...
	public AddressAlertDialog setMsg(String msg) {
		showMsg = true;
		if ("".equals(msg)) {
			txt_msg.setText("内容");
		} else {
	...
	public AddressAlertDialog setView(View view) {
		showLayout = true;
		if (view == null) {
			showLayout = false;
		} else
	...
	public AddressAlertDialog setCancelable(boolean cancel) {
		dialog.setCancelable(cancel);
		return this;
	}

	public AddressAlertDialog setPositiveButton(String text,
	...
	public AddressAlertDialog setNegativeButton(String text,
										   final OnClickListener listener) {
		showNegBtn = true;
		if ("".equals(text)) {
			btn_neg.setText("取消");

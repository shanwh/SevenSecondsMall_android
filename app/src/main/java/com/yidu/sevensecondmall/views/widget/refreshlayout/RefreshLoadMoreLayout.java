package com.yidu.sevensecondmall.views.widget.refreshlayout;
...
//                XLog.d("ACTION_UP");
    ...
    private void setRefreshLayout() {
        ...
        mHeaderLayout.setPullDownText(downtext);
        mHeaderLayout.setPullRefreshText(refreshtext);
        mHeaderLayout.setOnRefreshText(onrefreshtext);
    ...
    private String downtext = "下拉更新";

    public void setPullDownText(String text) {
        downtext = text;
    }

    private String refreshtext = "松开更新";

    public void setPullRefreshText(String text) {
        refreshtext = text;
    }

    private String onrefreshtext = "正在努力更新";

    public void setOnRefreshText(String text) {
        onrefreshtext = text;
    }
    ...
    private void setLoadMoreLayout() {
        ...
        mFooterLayout.setLoadMoreReleaseText(loadmorereleasetext);
        mFooterLayout.setLoadMoreUpText(loadmoreuptext);
        mFooterLayout.setonBackNormalStatusText(onbacknormalstatus);
        mFooterLayout.setCallBack(getCallBack());
        mFooterLayout.setFooterHeight(0);
        addView(mFooterLayout);
    }

    private String onbacknormalstatus = "上拉加载更多";

    public void setonBackNormalStatusText(String text) {
        onbacknormalstatus = text;
    }

    private String loadmoreuptext = "上拉加载更多";

    public void setLoadMoreUpText(String text) {
        loadmoreuptext = text;
    }

    private String loadmorereleasetext = "松开加载更多";

    public void setLoadMoreReleaseText(String text) {
        loadmorereleasetext = text;
    }

...
public class CircularProgressBar extends View {
	...
	private int mPrimaryColor = Color.parseColor("#ff8d23");
	private float mStrokeWidth = 10F;
	
	/**
	 * 进度条改变监听
	 * 
	 * {@link #onChange( int duration, float progress, float rate)}
	 */
	public interface OnProgressChangeListener {
		 ...
		 */
		public void onChange(int duration, float progress, float rate);
	}

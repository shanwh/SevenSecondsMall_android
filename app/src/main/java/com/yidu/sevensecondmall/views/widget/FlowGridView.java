 ...
 */
public class FlowGridView extends GridLayout {
...
//    int maxCount = 5;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            totalwidth = totalwidth + childwith + 40;
//            Log.e(TAG, "onMeasure: "+ totalwidth);
...
//            }
            if (totalwidth > screenwidth) {
                column++;
                totalwidth = views.get(i).getMeasuredWidth() + 40;
            }
...
//        int realheight = childheight * column + 60;
        int realheight = (childheight + paddingBottom + paddingtop + 15) * column ;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            totalwidth = totalwidth + views.get(i).getMeasuredWidth() + 40;
//            Log.e(TAG, "onLayout: "+totalwidth );
//            if (i != 0 && i % maxCount == 0) {
//                column++;
//            }
...
//            if (i != 0 && i % maxCount == 0) {
                ...
                if (i != 0) {
                    childleft += getChildAt(i - 1).getMeasuredWidth() + 40;
                }

            }

            child.layout(childleft, (column - 1) * (childheight + 15), childwith + childleft, (childheight + 15) * (column));
    ...
    public class FlowObservable extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            for (int i = 0; i < mItemCount; i++) {
                View child = adapter.getView(i, null, FlowGridView.this);
                addView(child);
                views.add(child);
            }

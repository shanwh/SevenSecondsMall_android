package com.yidu.sevensecondmall.views.anim;
...
public class HeartLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        mAnimator = new PathAnimator(AbstractPathAnimator.Config.fromTypeArray(a, initX, textHight, pointx*3, dWidth, dHeight));
        a.recycle();
    }
    ...
    private static int[] drawableIds = new int[]{R.drawable.live_ic_love1, R.drawable.live_ic_love2, R.drawable.live_ic_love3, R.drawable.live_ic_love4, R.drawable.live_ic_love5, R.drawable.live_ic_love6};
    private Random random = new Random();

    public void addFavor() {
        HeartView heartView = new HeartView(getContext());
        heartView.setDrawable(drawableIds[random.nextInt(5)]);

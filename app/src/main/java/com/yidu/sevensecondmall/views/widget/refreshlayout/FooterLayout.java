...
public class FooterLayout extends FrameLayout {
    ...
    private void onBackNormalStatus() {
        ...
        mTitleTxt.setText(onbacknormalstatus);
    ...
    private void onCanReleaseStatus() {
        ...
        mTitleTxt.setText(loadmoretextrelease);
        mProgressBar.setVisibility(View.GONE);
    }

    //设置释放的文字
    private String loadmoretextrelease;

    public void setLoadMoreReleaseText(String text) {
        loadmoretextrelease = text;
    }

    //设置上拉文字
    private String loadmoreuptext;
    ...
    private void onPullUpStatus() {
        ...
        mTitleTxt.setText(R.string.rll_footer_hint_normal);
        mTitleTxt.setText(loadmoreuptext);
        mProgressBar.setVisibility(View.GONE);
    }

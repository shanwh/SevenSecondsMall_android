...
//    private int tabTextColor = 0x999999;
    private int tabSelectTextColor = 0xff8d23;
    private Typeface tabTypeface = null;
    private int tabTypefaceStyle = Typeface.NORMAL;

    private int lastScrollX = 0;

    private int tabBackgroundResId = R.drawable.item_selector;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabSelectedBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTabStrip_pstsTabSelectedBackground, tabSelectedBackgroundResId);
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                if (mDotList != null && mDotList.contains(i)) {
                    //tab.setCompoundDrawablesWithIntrinsicBounds(null, null, getResources().getDrawable(R.drawable.red_dot), null);
                } else {
                    tab.setCompoundDrawablesWithIntrinsicBounds(null, null, null, null);
                }

                if (icons != null && icons.length > 0) {
                    tab.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable(icons[i]), null, null);
                }
                tab.setTextSize(TypedValue.COMPLEX_UNIT_DIP, tabTextSize);
    ...
    public void addDot(int position) {
        ...
        if (!mDotList.contains(position)) {
            mDotList.add(position);
            updateTabStyles();
        }
    }
    ...
    public void removeDot(int position) {
        ...
        if (mDotList != null && mDotList.contains(position)) {

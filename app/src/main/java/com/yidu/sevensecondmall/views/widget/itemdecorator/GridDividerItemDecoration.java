...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
   ...
   */
  public GridDividerItemDecoration(Drawable horizontalDivider, Drawable verticalDivider, int numColumns,int padding) {
  ...
  private void drawVerticalDividers(Canvas canvas, RecyclerView parent) {
    int parentLeft = parent.getPaddingLeft() + mPadding;
    int parentRight = parent.getWidth() - parent.getPaddingRight() - mPadding;
